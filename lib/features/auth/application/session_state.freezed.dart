...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Failure? endedBecause)?  absent,TResult Function( Session session)?  active,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SessionAbsent() when absent != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( Failure? endedBecause)  absent,required TResult Function( Session session)  active,}) {final _that = this;
switch (_that) {
case SessionAbsent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Failure? endedBecause)?  absent,TResult? Function( Session session)?  active,}) {final _that = this;
switch (_that) {
case SessionAbsent() when absent != null:
return absent(_that.endedBecause);case SessionActive() when active != null:
return active(_that.session);case _:
