...
/// that answers without it must not make the listing unreadable.
 DateTime? get indexedAt;/// When the record was soft-deleted.
///
...
@override
int get hashCode => Object.hash(runtimeType,uuid,name,path,type,contentHash,indexedAt,deletedAt,missingAt);

@override
String toString() {
  return 'CatalogFile(uuid: $uuid, name: $name, path: $path, type: $type, contentHash: $contentHash, indexedAt: $indexedAt, deletedAt: $deletedAt, missingAt: $missingAt)';
}
...
@useResult
$Res call({
 String uuid, String name, String path, LibraryType type, String contentHash, DateTime? indexedAt, DateTime? deletedAt, DateTime? missingAt
});
...
/// Create a copy of CatalogFile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uuid = null,Object? name = null,Object? path = null,Object? type = null,Object? contentHash = null,Object? indexedAt = freezed,Object? deletedAt = freezed,Object? missingAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uuid,  String name,  String path,  LibraryType type,  String contentHash,  DateTime? indexedAt,  DateTime? deletedAt,  DateTime? missingAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CatalogFile() when $default != null:
return $default(_that.uuid,_that.name,_that.path,_that.type,_that.contentHash,_that.indexedAt,_that.deletedAt,_that.missingAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uuid,  String name,  String path,  LibraryType type,  String contentHash,  DateTime? indexedAt,  DateTime? deletedAt,  DateTime? missingAt)  $default,) {final _that = this;
switch (_that) {
case _CatalogFile():
return $default(_that.uuid,_that.name,_that.path,_that.type,_that.contentHash,_that.indexedAt,_that.deletedAt,_that.missingAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uuid,  String name,  String path,  LibraryType type,  String contentHash,  DateTime? indexedAt,  DateTime? deletedAt,  DateTime? missingAt)?  $default,) {final _that = this;
switch (_that) {
case _CatalogFile() when $default != null:
return $default(_that.uuid,_that.name,_that.path,_that.type,_that.contentHash,_that.indexedAt,_that.deletedAt,_that.missingAt);case _:
  return null;
...
class _CatalogFile extends CatalogFile {
  const _CatalogFile({required this.uuid, required this.name, required this.path, required this.type, this.contentHash = '', this.indexedAt, this.deletedAt, this.missingAt}): super._();
...
/// Create a copy of CatalogFile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? name = null,Object? path = null,Object? type = null,Object? contentHash = null,Object? indexedAt = freezed,Object? deletedAt = freezed,Object? missingAt = freezed,}) {
