...
import 'package:alexandria_desktop/features/viewers/application/comic_viewer_controller.dart';
import 'package:alexandria_desktop/features/viewers/domain/file_viewer.dart';
import 'package:alexandria_desktop/features/viewers/presentation/comic_viewer_screen.dart';
...
void main() {
  ...
  open(
    ...
    final catalog = FakeCatalogGateway(
      listings: {
        LibraryType.comic: CatalogListing.loaded(files: [file]),
      },
    );
